/** Nigerian states (incl. FCT) and their LGAs for admissions forms. */
...
export const STATE_LGAS: Record<NigerianState, readonly string[]> = {
  Abia: [
    "Aba North",
    "Aba South",
    "Arochukwu",
...
export function lgasForState(state: string | null | undefined): readonly string[] {
  if (!state || !isNigerianState(state)) return [];
